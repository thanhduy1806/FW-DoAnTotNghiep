...
{
    return gs_param_deserialize((gs_param_table_instance_t *) mem, buf, len, flags);
}
...
{
    return gs_param_deserialize_item((gs_param_table_instance_t *) mem, (const gs_param_table_row_t*)param, addr, item, flags);
}
