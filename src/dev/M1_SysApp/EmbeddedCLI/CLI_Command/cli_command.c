...
static const CliCommandBinding cliStaticBindings_internal[] = {
    { "Ultis", "dev", "", false, NULL, CMD_Dev,},
    { "Ultis", "help", "", false, NULL, CMD_Help,},
    { "Ultis", "cls", "", false, NULL, CMD_ClearCLI,},
    { "Time", "rtc_set", "", true, NULL, CMD_RtcSet,},
    { "Time", "rtc_get", "", true, NULL, CMD_RtcGet,},
    { "Time", "epoch_set", "", true, NULL, CMD_RtcSetEpoch,},

    { "System", "os_stat", "", false, NULL, CMD_OsStat,},
    { "System", "dmesg", "", true, NULL, CMD_Dmesg,},

    { "FRAM", "fram_write_read", "", false, NULL, CMD_FRAM_WriteRead,},

    { "CAN", "can_send", "", true, NULL, CMD_CanSend,},
    { "CSP", "csp_ping", "", true, NULL, CMD_CspPing,},
    { "CSP", "csp_send", "", true, NULL, CMD_CspSend,},
    { "CSP", "csp_info", "", false, NULL, CMD_CspInfo,},

    { "Param", "param_show", "", true, NULL, CMD_ParamShow},
    { "Param", "param_set", "", true, NULL, CMD_ParamSet},

    { "LED", "led_set", "", true, NULL, CMD_LED_Set},
    { "LED", "led_reset", "", true, NULL, CMD_LED_Reset},

    { "SOL", "sol_single_on", "", true, NULL, CMD_SOL_Single_On},
    { "SOL", "sol_single_off", "", true, NULL, CMD_SOL_Single_Off},
    { "SOL", "sol_single_get", "", true, NULL, CMD_SOL_Single_Get},
    { "SOL", "sol_dual_forward", "", true, NULL, CMD_SOL_Dual_Forward},
    { "SOL", "sol_dual_reverse", "", true, NULL, CMD_SOL_Dual_Reverse},

    { "HTR", "heater_set", "", true, NULL, CMD_HEATER_SetDuty},

    { "POWER", "power_som_on", "", false, NULL, CMD_PowerSOM_ON,},
    { "POWER", "power_som_off", "", false, NULL, CMD_PowerSOM_OFF},
    { "POWER", "power_som_get", "", false, NULL, CMD_PowerSOM_Get},

    { "POWER", "power_buck_peri_on", "", false, NULL, CMD_PowerBuckPeri_ON},
    { "POWER", "power_buck_peri_off", "", false, NULL, CMD_PowerBuckPeri_OFF},
    { "POWER", "power_buck_peri_get", "", false, NULL, CMD_PowerBuckPeri_Get},

    { "POWER", "power_tec_on", "", false, NULL, CMD_PowerTec_ON},
    { "POWER", "power_tec_off", "", false, NULL, CMD_PowerTec_OFF},
    { "POWER", "power_tec_get", "", false, NULL, CMD_PowerTec_Get},

    { "POWER", "power_hd4_on", "", false, NULL, CMD_PowerHD4_ON},
    { "POWER", "power_hd4_off", "", false, NULL, CMD_PowerHD4_OFF},
    { "POWER", "power_hd4_get", "", false, NULL, CMD_PowerHD4_Get},

    { "POWER", "power_solenoid_on", "", false, NULL, CMD_PowerSolenoid_ON},
    { "POWER", "power_solenoid_off", "", false, NULL, CMD_PowerSolenoid_OFF},
    { "POWER", "power_solenoid_get", "", false, NULL, CMD_PowerSolenoid_Get},

    { "POWER", "power_lp_on", "", false, NULL, CMD_PowerLP_ON},
    { "POWER", "power_lp_off", "", false, NULL, CMD_PowerLP_OFF},
    { "POWER", "power_lp_get", "", false, NULL, CMD_PowerLP_Get},

    { "POWER", "power_heater_on", "", false, NULL, CMD_PowerHeater_ON},
    { "POWER", "power_heater_off", "", false, NULL, CMD_PowerHeater_OFF},
    { "POWER", "power_heater_get", "", false, NULL, CMD_PowerHeater_Get},

    { "POWER", "power_all_on", "", false, NULL, CMD_PowerAll_ON},
    { "POWER", "power_all_off", "", false, NULL, CMD_PowerAll_OFF},
    { "POWER", "power_all_get", "", false, NULL, CMD_PowerAll_Get},

    { "BMP390", "bmp390_int_read", "", false, NULL, CMD_BMP390_Int_Read},
    { "BMP390", "bmp390_ext_read", "", false, NULL, CMD_BMP390_Ext_Read},
    { "BMP390", "bmp390_ext_ena", "", false, NULL, CMD_BMP390_Ext_Ena},
    { "BMP390", "bmp390_ext_dis", "", false, NULL, CMD_BMP390_Ext_Dis},

    { "TEST", "echo", "", true, NULL, CMD_CLI_Echo},
    { "TEST", "expander_write", "", true, NULL, CMD_Expander_Write},
    { "TEST", "expander_read", "", false, NULL, CMD_Expander_Read},
    { "TEST", "ntc_check", "", true, NULL, CMD_Check_NTC},

    { "TEC", "tec_init", "", true, NULL, CMD_TEC_Init},
    { "TEC", "tec_vol", "", true, NULL, CMD_TEC_Set_Vol},
    { "TEC", "tec_en", "", true, NULL, CMD_TEC_En},
    { "TEC", "tec_swen", "", true, NULL, CMD_TEC_SWen},
    { "TEC", "tec_read_reg", "", true, NULL, CMD_TEC_Read_Reg},

    { "LASER", "laser_int_set_dac", "", true, NULL, CMD_Laser_Int_Set_DAC},
    { "LASER", "laser_int_sw_on", "", true, NULL, CMD_Laser_Int_Turn_On_Channel},
    { "LASER", "laser_int_sw_off", "", true, NULL, CMD_Laser_Int_Turn_Off_Channel},
    { "LASER", "laser_int_sw_off_all", "", true, NULL, CMD_Laser_Int_Turn_Off_All},

    { "PHOTO", "photo_sw_on", "", true, NULL, CMD_Photo_Turn_On_Channel},

    { "NTC", "ntc_read", "", true, NULL, CMD_NTC_Read},
    { "NTC", "ntc_read_all", "", true, NULL, CMD_NTC_Read_All},

    { "RTC", "rtc_read", "", true, NULL, CMD_RTC_Read},
    { "RTC", "rtc_set_date", "", true, NULL, CMD_RTC_Set_Date},
    { "RTC", "rtc_set_time", "", true, NULL, CMD_RTC_Set_Time},
    { "RTC", "rtc_ping", "", true, NULL, CMD_RTC_Ping},
    { "RTC", "rtc_test", "", true, NULL, CMD_RTC_Test},

    { "FLOW", "flow_read_all", "", true, NULL, CMD_Flow_Sen_ReadAll},

    { "EXP", "exp_profile", "", true, NULL, CMD_Exp_Set_Profile},
    { "EXP", "exp_start", "", true, NULL, CMD_Exp_Start},
    { "EXP", "exp_start_laser", "", true, NULL, CMD_Exp_Start_Laser},
    { "EXP", "exp_end", "", true, NULL, CMD_Exp_End},
    { "EXP", "dls_setup", "", true, NULL, CMD_DLS_setup},
    { "EXP", "dls_start", "", true, NULL, CMD_Exp_Start},

    { "PUMP", "pump_enable", "", true, NULL, CMD_PUMP_Enable},
    { "PUMP", "pump_disable", "", true, NULL, CMD_PUMP_Disable},
    { "PUMP", "pump_set_volt", "", true, NULL, CMD_PUMP_Set_Volt},
    { "PUMP", "pump_set_freq", "", true, NULL, CMD_PUMP_Set_Freq},

    { "TEMP", "temp_profile_set", "", true, NULL, CMD_Temp_profile_set},
    { "TEMP", "temp_prof_set", "", true, NULL, CMD_Temp_prof_set},
    { "TEMP", "temp_profile_diplay", "", true, NULL, CMD_DB_TempProfile_display},
    { "TEMP", "temp_profile_val", "", true, NULL, CMD_DB_TempProfile_validation},
    { "TEMP", "temp_auto_ena", "", true, NULL, CMD_Temp_auto_ena},
    { "TEMP", "temp_auto_start", "", true, NULL, CMD_Temp_auto_start},    
    { "TEMP", "temp_auto_pid_set", "", true, NULL, CMD_Temp_PID_set},
    { "TEMP", "temp_auto_pid_get", "", true, NULL, CMD_Temp_PID_get},
    { "TEMP", "temp_manu", "", true, NULL, CMD_Temp_manu},
    { "TEMP", "c", "", true, NULL, CMD_Temp_log_toggle},

    { "PSRAM", "psram_sw_mcu", "", true, NULL, CMD_PSRAM_Switch_MCU},
    { "PSRAM", "psram_sw_pmu", "", true, NULL, CMD_PSRAM_Switch_PMU},
    { "PSRAM", "psram_id", "", true, NULL, CMD_PSRAM_Read_ID},
    { "PSRAM", "psram_write", "", true, NULL, CMD_PSRAM_Write_Byte},
    { "PSRAM", "psram_read", "", true, NULL, CMD_PSRAM_Read_Byte},

    { "LSM6", "lsm6d_conf_accel", "", true, NULL, CMD_LSM6DSOX_Config_Accel},
    { "LSM6", "lsm6d_conf_gyro", "", true, NULL, CMD_LSM6DSOX_Config_Gyro},
    { "LSM6", "lsm6d_conf_int", "", true, NULL, CMD_LSM6DSOX_Config_Int},
    { "LSM6", "lsm6d_conf_ff", "", true, NULL, CMD_LSM6DSOX_Config_FF},
    { "LSM6", "lsm6d_conf_wu", "", true, NULL, CMD_LSM6DSOX_Config_WU},
    { "LSM6", "lsm6d_init", "", true, NULL, CMD_LSM6DSOX_Init},
    { "LSM6", "lsm6d_dis_int", "", true, NULL, CMD_LSM6DSOX_Dis_Int},
    { "LSM6", "lsm6d_check", "", true, NULL, CMD_LSM6DSOX_Check},
    { "LSM6", "lsm6d_read_all", "", true, NULL, CMD_LSM6DSOX_Read_All},
    { "LSM6", "lsm6d_read_accel", "", true, NULL, CMD_LSM6DSOX_Read_Accel},
    { "LSM6", "lsm6d_read_gyro", "", true, NULL, CMD_LSM6DSOX_Read_Gyro},
    { "LSM6", "lsm6d_read_temp", "", true, NULL, CMD_LSM6DSOX_Read_Temp},

    { "PWR MEAS", "get_i_pwr", "", true, NULL, CMD_Get_Current_Value_Power},
    { "PWR MEAS", "get_v_tec", "", true, NULL, CMD_Get_Voltage_Value},
    { "PWR MEAS", "get_adc_raw", "", true, NULL, CMD_Get_ADC_Value_Monitor},
    { "PWR MEAS", "sw_on", "", true, NULL, CMD_Switch_On_To_ADC},
    { "PWR MEAS", "sw_off", "", true, NULL, CMD_Switch_Off_To_ADC},
    { "PWR MEAS", "sw_status", "", true, NULL, CMD_Get_All_Switch_Status},

    { NULL, "a", "", false, NULL, CMD_a},
    { NULL, "b", "", false, NULL, CMD_b},
    { NULL, "d", "", false, NULL, CMD_d},
    { NULL, "reset", "", false, NULL, CMD_Reset},
};
